var Le={getAllDepartments:"http://js-ass3-btol.herokuapp.com/api/departments/",getDepartment:a=>`http://js-ass3-btol.herokuapp.com/api/departments/name/${a}`,deleteEmployee:a=>`http://js-ass3-btol.herokuapp.com/api/departments/employee/id/${a}`,updateEmployee:a=>"http://js-ass3-btol.herokuapp.com/api/departments/employee/update"},L=Le;var Se=async a=>await(await fetch(a)).json(),Ce=async a=>await(await fetch(a,{method:"DELETE",redirect:"follow"})).json(),Ae=async(a,n)=>{let s=new Headers;s.append("Content-Type","application/json");let o=JSON.stringify(n),m=await(await fetch(a,{method:"PUT",headers:s,body:o,redirect:"follow"})).text()},De={getRequest:Se,deleteRequest:Ce,putRequest:Ae},S=De;var Oe=function(){let a=null;function n(){let s=document.createElement("img");document.body.appendChild(s);let o=async m=>{let u=await S.deleteRequest(L.deleteEmployee(m.detail.id));console.log(u),s.dispatchEvent(new CustomEvent("removeItem",{bubbles:!0,detail:u}))},c=async m=>{let u=await S.putRequest(L.updateEmployee,m.detail.payload)},h=async m=>{let u=await S.getRequest(L.getDepartment(m.detail.name));s.dispatchEvent(new CustomEvent("updateDisplay",{bubbles:!0,detail:u}))};return s.addEventListener("deleteEmployee",o),s.addEventListener("editEmployee",c),s.addEventListener("sideBarSelect",h),{handle:s}}return{getInstance:function(){return a||(a=n()),a}}}(),A=Oe;var Z=`
    <ul class="departments"></ul>
`,K=`
   <li class="department" data-name="<%-data.name%> "><%-data.name%></li>
`;function xe(a){return document.createRange().createContextualFragment(a).firstElementChild}var T=xe;var Fe=function(){return T(Z)},Q=Fe;function Y(a,n,s){return s={path:n,exports:{},require:function(o,c){return Ie(o,c??s.path)}},a(s,s.exports),s.exports}function Ie(){throw new Error("Dynamic requires are not currently supported by @rollup/plugin-commonjs")}var P={};function ee(a,n){for(var s=0,o=a.length-1;o>=0;o--){var c=a[o];c==="."?a.splice(o,1):c===".."?(a.splice(o,1),s++):s&&(a.splice(o,1),s--)}if(n)for(;s--;s)a.unshift("..");return a}var Me=/^(\/?|)([\s\S]*?)((?:\.{1,2}|[^\/]+?|)(\.[^.\/]*|))(?:[\/]*)$/,k=function(a){return Me.exec(a).slice(1)};function M(){for(var a="",n=!1,s=arguments.length-1;s>=-1&&!n;s--){var o=s>=0?arguments[s]:"/";if(typeof o!="string")throw new TypeError("Arguments to path.resolve must be strings");if(!o)continue;a=o+"/"+a,n=o.charAt(0)==="/"}return a=ee(q(a.split("/"),function(c){return!!c}),!n).join("/"),(n?"/":"")+a||"."}function B(a){var n=N(a),s=Re(a,-1)==="/";return a=ee(q(a.split("/"),function(o){return!!o}),!n).join("/"),!a&&!n&&(a="."),a&&s&&(a+="/"),(n?"/":"")+a}function N(a){return a.charAt(0)==="/"}function te(){var a=Array.prototype.slice.call(arguments,0);return B(q(a,function(n,s){if(typeof n!="string")throw new TypeError("Arguments to path.join must be strings");return n}).join("/"))}function ne(a,n){a=M(a).substr(1),n=M(n).substr(1);function s(g){for(var _=0;_<g.length&&g[_]==="";_++);for(var w=g.length-1;w>=0&&g[w]==="";w--);return _>w?[]:g.slice(_,w-_+1)}for(var o=s(a.split("/")),c=s(n.split("/")),h=Math.min(o.length,c.length),m=h,u=0;u<h;u++)if(o[u]!==c[u]){m=u;break}for(var p=[],u=m;u<o.length;u++)p.push("..");return p=p.concat(c.slice(m)),p.join("/")}var ae="/",re=":";function ie(a){var n=k(a),s=n[0],o=n[1];return!s&&!o?".":(o&&(o=o.substr(0,o.length-1)),s+o)}function se(a,n){var s=k(a)[2];return n&&s.substr(-1*n.length)===n&&(s=s.substr(0,s.length-n.length)),s}function oe(a){return k(a)[3]}var Pe={extname:oe,basename:se,dirname:ie,sep:ae,delimiter:re,relative:ne,join:te,isAbsolute:N,normalize:B,resolve:M};function q(a,n){if(a.filter)return a.filter(n);for(var s=[],o=0;o<a.length;o++)n(a[o],o,a)&&s.push(a[o]);return s}var Re="ab".substr(-1)==="b"?function(a,n,s){return a.substr(n,s)}:function(a,n,s){return n<0&&(n=a.length+n),a.substr(n,s)},ke=Object.freeze({__proto__:null,resolve:M,normalize:B,isAbsolute:N,join:te,relative:ne,sep:ae,delimiter:re,dirname:ie,basename:se,extname:oe,default:Pe}),E=Y(function(a,n){var s=/[|\\{}()[\]^$+*?.]/g;n.escapeRegExpChars=function(u){return u?String(u).replace(s,"\\$&"):""};var o={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&#34;","'":"&#39;"},c=/[&<>'"]/g;function h(u){return o[u]||u}var m=`var _ENCODE_HTML_RULES = {
      "&": "&amp;"
    , "<": "&lt;"
    , ">": "&gt;"
    , '"': "&#34;"
...
`+m},n.shallowCopy=function(u,p){p=p||{};for(var g in p)u[g]=p[g];return u},n.shallowCopyFromList=function(u,p,g){for(var _=0;_<g.length;_++){var w=g[_];typeof p[w]!="undefined"&&(u[w]=p[w])}return u},n.cache={_data:{},set:function(u,p){this._data[u]=p},get:function(u){return this._data[u]},remove:function(u){delete this._data[u]},reset:function(){this._data={}}},n.hyphenToCamel=function(u){return u.replace(/-[a-z]/g,function(p){return p[1].toUpperCase()})}}),qe="ejs",Ne="Embedded JavaScript templates",Be=["template","engine","ejs"],He="3.1.6",We="Matthew Eernisse <mde@fleegix.org> (http://fleegix.org)",$e="Apache-2.0",Ue={ejs:"./bin/cli.js"},Ve="./lib/ejs.js",ze="ejs.min.js",Je="ejs.min.js",Xe={type:"git",url:"git://github.com/mde/ejs.git"},Ge="https://github.com/mde/ejs/issues",Ze="https://github.com/mde/ejs",Ke={jake:"^10.6.1"},Qe={browserify:"^16.5.1",eslint:"^6.8.0","git-directory-deploy":"^1.5.1",jsdoc:"^3.6.4","lru-cache":"^4.0.1",mocha:"^7.1.1","uglify-js":"^3.3.16"},Ye={node:">=0.10.0"},et={test:"mocha"},tt={name:qe,description:Ne,keywords:Be,version:He,author:We,license:$e,bin:Ue,main:Ve,jsdelivr:ze,unpkg:Je,repository:Xe,bugs:Ge,homepage:Ze,dependencies:Ke,devDependencies:Qe,engines:Ye,scripts:et},nt=Y(function(a,n){var s=ke,o=!1,c=tt.version,h="<",m=">",u="%",p="locals",g="ejs",_="(<%%|%%>|<%=|<%-|<%_|<%#|<%|%>|-%>|_%>)",w=["delimiter","scope","context","debug","compileDebug","client","_with","rmWhitespace","strict","filename","async"],ye=w.concat("cache"),$=/^\uFEFF/;n.cache=E.cache,n.fileLoader=P.readFileSync,n.localsName=p,n.promiseImpl=new Function("return this;")().Promise,n.resolveInclude=function(t,r,e){var i=s.dirname,l=s.extname,d=s.resolve,v=d(e?r:i(r),t),j=l(t);return j||(v+=".ejs"),v};function U(t,r){var e;if(r.some(function(i){return e=n.resolveInclude(t,i,!0),P.existsSync(e)}))return e}function Ee(t,r){var e,i,l=r.views,d=/^[A-Za-z]+:\\|^\//.exec(t);if(d&&d.length)t=t.replace(/^\/*/,""),Array.isArray(r.root)?e=U(t,r.root):e=n.resolveInclude(t,r.root||"/",!0);else if(r.filename&&(i=n.resolveInclude(t,r.filename),P.existsSync(i)&&(e=i)),!e&&Array.isArray(l)&&(e=U(t,l)),!e&&typeof r.includer!="function")throw new Error('Could not find the include file "'+r.escapeFunction(t)+'"');return e}function O(t,r){var e,i=t.filename,l=arguments.length>1;if(t.cache){if(!i)throw new Error("cache option requires a filename");if(e=n.cache.get(i),e)return e;l||(r=V(i).toString().replace($,""))}else if(!l){if(!i)throw new Error("Internal EJS error: no file name or template provided");r=V(i).toString().replace($,"")}return e=n.compile(r,t),t.cache&&n.cache.set(i,e),e}function _e(t,r,e){var i;if(e){try{i=O(t)(r)}catch(l){return e(l)}e(null,i)}else{if(typeof n.promiseImpl=="function")return new n.promiseImpl(function(l,d){try{i=O(t)(r),l(i)}catch(v){d(v)}});throw new Error("Please provide a callback function")}}function V(t){return n.fileLoader(t)}function we(t,r){var e=E.shallowCopy({},r);if(e.filename=Ee(t,e),typeof r.includer=="function"){var i=r.includer(t,e.filename);if(i&&(i.filename&&(e.filename=i.filename),i.template))return O(e,i.template)}return O(e)}function z(t,r,e,i,l){var d=r.split(`
...
`)}},n.escapeXML=E.escapeXML,n.__express=n.renderFile,n.VERSION=c,n.name=g,typeof window!="undefined"&&(window.ejs=n)}),le=nt;function at(a,n){return le.render(a,{data:n})}var D=at;var rt=A.getInstance(),ce=new CustomEvent("sideBarSelect",{bubbles:!0,detail:{name:null}}),st=function(a){let n=D(K,a),s=T(n);return s.addEventListener("click",it),s},it=a=>{ce.detail.name=a.currentTarget.dataset.name,rt.handle.dispatchEvent(ce)},ue=st;var ot=document.querySelector("#sidebar"),lt=function(){return{init:function(n){let s=Q();n.forEach(o=>{let c=ue(o);s.append(c)}),ot.append(s)}}},me=lt;var ct=`
...
`,mt={parentTemplate:ut,childTemplate:ct},H=mt;var dt=a=>{let n=document.querySelector("#managers"),s=a.filter(c=>c.role),o=T(H.parentTemplate);return s.forEach(c=>{let h=D(H.childTemplate,c),m=T(h);o.appendChild(m)}),o},de=dt;var pe=`
...
`;var W=A.getInstance(),pt=function(a){let n=T(pe),s=a.filter(c=>!c.role),o=c=>{switch(c.target.id){case"delete":W.handle.dispatchEvent(new CustomEvent("deleteEmployee",{bubbles:!0,detail:{id:c.currentTarget.dataset.id}})),n.removeChild(c.currentTarget.parentElement);break;case"edit":let h={id:c.currentTarget.dataset.id,firstname:c.currentTarget.parentElement.querySelector("#firstname").value.trim(),lastname:c.currentTarget.parentElement.querySelector("#lastname").value.trim(),salary:c.currentTarget.parentElement.querySelector("#salary").value.trim(),vacation:c.currentTarget.parentElement.querySelector("#vacation").value.trim()};W.handle.dispatchEvent(new CustomEvent("editEmployee",{bubbles:!0,detail:{payload:h}})),W.handle.dispatchEvent(new CustomEvent("editEmployee",{bubbles:!0,detail:{payload:h}}));break}};return s.forEach(c=>{let h=D(fe,c),m=T(h);m.querySelector(".controls").addEventListener("click",o),n.appendChild(m)}),n},he=pt;var ft=()=>{let a=document.querySelector("#panel"),n=document.querySelector("#widget-heading"),s=null,o=null,c=m=>{n.textContent=`${m[0].department} department`,s=a.appendChild(de(m)),o=a.appendChild(he(m))};return{updateDisplay:m=>{a.removeChild(s),a.removeChild(o),c(m)},view:a,init:c}},ve=ft;var ge=ve(),ht=me(),vt=A.getInstance();vt.handle.addEventListener("updateDisplay",a=>{ge.updateDisplay(a.detail)});var gt=async function(){let a=await S.getRequest(L.getAllDepartments),n=await S.getRequest(L.getDepartment("training"));ht.init(a),ge.init(n)};gt();
/**
