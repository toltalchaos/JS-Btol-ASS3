...
class Department {
  ...
  updateEmployeeData(data){
    //  snippet # 8
    const employees = this.getData() //get entire file
    const employee = employees.find(employee => employee.id === data.id) //looking for the employee that matches the ID passed

     const updatedEmployee = {...employee, ...data}//spread the employee information and overwrite with "data"
    ...
    this.writeData(newEmployeeData) //writing over entire file with new employee data
